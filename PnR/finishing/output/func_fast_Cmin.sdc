################################################################################
#
# Design name:  cv32e40p_finish
#
# Created by icc2 write_sdc on Sun Jun 29 23:06:00 2025
#
################################################################################
...
# -origin user
set_clock_latency -min 0.0755525 [get_clocks {clk_i}]
# -origin user
set_clock_latency -max 0.0761575 [get_clocks {clk_i}]
# Set propagated on clock sources to avoid removing latency for IO paths.
set_propagated_clock  [get_ports {clk_i}]
# /mnt/hgfs/GP/Synthesis/sdc/cv32e40p_top.sdc, line 10
set_driving_cell -lib_cell SAEDRVT14_BUF_1 -pin X [get_ports {clk_i}]
# /mnt/hgfs/GP/Synthesis/sdc/cv32e40p_top.sdc, line 11
...
set_driving_cell -lib_cell SAEDRVT14_BUF_1 -pin X [get_ports \
    {dm_halt_addr_i[31]}]
